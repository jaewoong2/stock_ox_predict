...
from myapi.core.auth_middleware import get_current_active_user, get_current_user_optional
...
def validate_nickname_availability(
    ...
    try:
        exclude_user_id = current_user.id if current_user else None
        is_available = user_service.validate_nickname_availability(nickname, exclude_user_id)
