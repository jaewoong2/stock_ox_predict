...
from myapi.schemas.ad_unlock import AdUnlockResponse, AdUnlockHistory
...
class AdUnlockRepository(BaseRepository[AdUnlockModel, AdUnlockResponse]):
    ...
    def get_user_daily_unlocks(
        ...
        return [self._to_schema(record) for record in records if self._to_schema(record) is not None]
